...
<table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" class="main-template" bgcolor="#f9fafc" style="background-color: rgb(249, 250, 252);">
    ...
    <tbody><tr>
                            ...
                            <tbody><tr>
                                <td valign="top" align="center">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tbody><tr>
                                            <td>
                                                <div style="border-radius:5px; width:314;;max-width:314px !important;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;border-collapse: separate;border-radius: 0px;">
                                                    <div><img ng-if="col.img.source != 'url'" border="0" hspace="0" vspace="0" width="314" class="rnb-header-img" alt="" style="display:block; float:left; border-radius: 5px; " src="https://img.mailinblue.com/3855876/images/rnb/original/60db63d57044560e05047d95.png"></div><div style="clear:both;"></div>
                                                    </div></td>
                                        </tr>
                                    </tbody></table>
        ...
        <td align="center" valign="top">
            ...
            <div style="background-color: rgb(28, 16, 59); border-radius: 0px;">
                ...
                <table width="100%" cellpadding="0" border="0" cellspacing="0" name="Layout_2" id="Layout_2"><tbody><tr>
                    <td align="center" valign="top"><a href="#" name="Layout_2"></a>
                        <table border="0" width="100%" cellpadding="0" cellspacing="0" class="rnb-container" bgcolor="#1C103B" style="height: 0px; background-color: rgb(28, 16, 59); border-radius: 0px; border-collapse: separate; padding: 20px;"><tbody><tr>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                    ...
                                                    <tr>
                                                        <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:center;">
                                                            ...
                                                            <span style="color:#3c4858;"><span style="color:#FFFFFF;"><span style="font-size: 24px;"><b>Bienvenido</b></span></span></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10"></td>
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                ...
                                                                <tbody><tr>
                                                                    <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;"><div>Has sido registrado en la Salle Oaxaca<br>
<br>Nombre: ${alumno.nombre}
<br>
Usuario: ${alumno.matricula}<br>
Contraseña: ${alumno.contraseña}</div>
</td>
                                                                </tr>
                                                                </tbody></table>
        ...
        <td align="center" valign="top">
            ...
            <div style="background-color: rgb(28, 16, 59);">
                ...
                <table class="rnb-del-min-width rnb-tmpl-width" width="100%" cellpadding="0" border="0" cellspacing="0" style="min-width:590px;" name="Layout_5" id="Layout_5">
                    <tbody><tr>
                        <td class="rnb-del-min-width" align="center" valign="top" bgcolor="#1C103B" style="min-width: 590px; background-color: rgb(28, 16, 59);">
                                                                ...
                                                                <table cellpadding="0" border="0" align="left" cellspacing="0" class="rnb-btn-col-content">
                                                                    <tbody><tr>
                                                                        <td valign="middle" align="left" style="font-size:14px; font-family:Arial,Helvetica,sans-serif; color:#888888; line-height: 16px" class="rnb-text-center">
                                                                            <div><div><span style="font-size:16px;"><span style="color:#FFFFFF;">Camino a San Agustín #407,<br>
Santa Cruz Xoxocotlán, Oaxaca. C.P. 71230<br>
(951) 502 93 33 / 01 800 502 93 33</span></span></div>
</div>
                                                                        </td></tr>
                                                                </tbody></table>
                                                            </td>
